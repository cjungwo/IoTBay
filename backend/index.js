...
// Creating endpoint for popular in motor section
app.get('/popularin', async (req,res) => {
    let products = await Product.find({category: "motors"});
    let popular_in_motor = products.slice(0).slice(-4);
    console.log("Popular in motor fetched");
    console.log(popular_in_motor);
    res.send(popular_in_motor);
});
