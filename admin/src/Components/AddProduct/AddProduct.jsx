    ...
    <div className='addproduct'>
        ...
        <div className="addproduct_itemfield">
            ...
            <select value={productDetails.category} onChange={changeHandler} name="category" className='addproduct_selector'>
                <option value="temperature">Temperature / Humidity / Air Pressure / Gas</option>
                <option value="motion">Motion Sensors</option>
                <option value="navigation">Navigation Modules</option>
                <option value="wireless">Wireless / Infrared (IR) / Bluetooth</option>
                <option value="motors">Motors</option>
                <option value="analogue">Analogue Sensors</option>
        ...
        <div className="addproduct_itemfield">
            <label htmlFor="file-input">
                <img src={
                    ...
                    } alt="upload area" className='addproduct_thumnail_img' />
            </label>
